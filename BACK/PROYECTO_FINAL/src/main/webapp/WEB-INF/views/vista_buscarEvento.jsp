...
<div class="container">
  ...
  <div class="jumbotron">
   ...
   <form action="crearEvento" class="form-horizontal" method="post"> 
 
  <div class="form-group">

    <label class="control-label col-sm-2" for="localizacion">Localización:</label>
    <div class="col-sm-10">
      <input type="localizacion" name="localizacion" class="form-control" id="localizacion" placeholder="Introduce localización">
    </div>
  </div>
  <div class="form-group">
